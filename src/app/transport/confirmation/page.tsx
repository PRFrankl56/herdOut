    ...
    <main className="min-h-screen bg-brand-green flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-white/80 text-base mb-8">
          Thank you for volunteering to help transport animals. Your rig details
          are now visible to coordinators and livestock owners who need
          evacuation help. Keep your phone nearby.
        </p>
        <Link
          href="/"
